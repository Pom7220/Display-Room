...
1. **IT admin: Persistent browser session** — Azure AD Conditional Access → set on `rismeetingroomsystem@central.co.th`. Extends silent renewal from 24 hours to 90 days
